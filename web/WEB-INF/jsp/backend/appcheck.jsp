...
<div class="row">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="flatformName" type="text" class="form-control col-md-7 col-xs-12"
                     value="${ExtAppInfo.platformName}" readonly="readonly">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="category" type="text" class="form-control col-md-7 col-xs-12"
                     value="${ExtAppInfo.categoryLv1} --> ${ExtAppInfo.categoryLv2} --> ${ExtAppInfo.categoryLv3}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="statusName" type="text" class="form-control col-md-7 col-xs-12"
                     value="${ExtAppInfo.appStatus}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
  ...
  <script src="${pageContext.request.contextPath }/myProjectAssets/localjs/appcheck.js"></script>