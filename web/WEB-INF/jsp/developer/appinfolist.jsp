			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
        						<select name="queryCategoryLevel3" id="categoryLevel3" class="form-control level">
									<option value="-1">--请选择--</option>
				...
				<div class="row">
					...
					<a href="appController/add" class="btn btn-success btn-sm">新增APP基础信息</a>
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<tbody>
								<c:forEach var="appInfo" items="${pageInfo.appInfos}" varStatus="status">
									<tr role="row" class="odd">
										<td tabindex="0" class="sorting_1">${appInfo.softwareName}</td>
										<td>${appInfo.apkName }</td>
										<td>${appInfo.softwareSize }</td>
										<td>${appInfo.platformName }</td>
										<td>${appInfo.categoryLv1} -> ${appInfo.categoryLv2} -> ${appInfo.categoryLv3}</td>
										<td><span id="appInfoStatus${appInfo.id}">${appInfo.appStatus}</span></td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a class="modifyVersion" 
											...
											statusname="${appInfo.dataDictionary.valueName}"
											data-toggle="tooltip" data-placement="top" title="" data-original-title="修改APP最新版本信息">修改版本</a>
                        </li>
                        <li><a  class="modifyAppInfo" 
											appinfoid="${appInfo.id }" status="${appInfo.status }" statusname="${appInfo.dataDictionary.valueName }"
